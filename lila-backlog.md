...
- [x] **Card Deck system** (Apr 2026) — 30-card practice deck replaces the AI-generated mindfulness pick. Five-principle taxonomy (Presence / Oneness / Flow / Compassion / Reverence). Implemented per `claude-code-brief-card-deck.md`:
  ...
  - [x] Meditations polish (Apr 2026) — warm linen outer background (#E8E0D5, fixed, no principle color shift), desk-feel card shadow, navigation arrows to #8C7B6B. Orientation screen: bumped tradition taglines to 11px with more row padding, arc phrases to white Quicksand. Practice cards: removed counter, enlarged flip arrow to 22px with "explore" label. Quote block across both Meditations + PracticeCardModal: all Quicksand, weight 500, no italic.
