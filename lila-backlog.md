...
- [x] **Card Deck system** (Apr 2026) — 30-card practice deck replaces the AI-generated mindfulness pick. Five-principle taxonomy (Presence / Oneness / Flow / Compassion / Reverence). Implemented per `claude-code-brief-card-deck.md`:
  ...
  - [x] Practice card restructure (Apr 2026) — new front face: practiceTitle (invitational, 3-6 words), frontParagraph (40-60 words, nature-grounded), reflection line. New back face: teaching as opening, quote with soft hairlines, connection section. Three new fields in cardDeck.js (practiceTitle, frontParagraph, reflection). Script at scripts/generate-practice-fronts.js. Applied to both Meditations.jsx and PracticeCardModal.jsx. Note: practiceTitle and frontParagraph values are generated placeholders pending review.
