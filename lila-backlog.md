...
- [x] **Card Deck system** (Apr 2026) — 30-card practice deck replaces the AI-generated mindfulness pick. Five-principle taxonomy (Presence / Oneness / Flow / Compassion / Reverence). Implemented per `claude-code-brief-card-deck.md`:
  ...
  - [x] Meditations polish (Apr 2026) — warm linen background (#E8E0D5 fixed), desk-feel shadow, #6B5A50 arrows (12x22px, strokeWidth 2, opacity 0.6/0.15/1.0), 16px outer padding. Orientation: section labels 10px/0.5, symbols 0.6, taglines 11px/0.55, arc phrases 12px/0.75 white Quicksand. Front face: tradition 10px/0.7, subtitle 12px/0.75. Chapter number removed. Flip arrow 22px + "explore" label. Quote block all Quicksand weight 500 (both Meditations + PracticeCardModal).
