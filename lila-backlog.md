...
- [x] **Card Deck system** (Apr 2026) — 30-card practice deck replaces the AI-generated mindfulness pick. Five-principle taxonomy (Presence / Oneness / Flow / Compassion / Reverence). Implemented per `claude-code-brief-card-deck.md`:
  ...
  - [x] Practice card restructure (Apr 2026) — new front face: practiceTitle, frontParagraph, reflection. New back face: backOpening, quote, connection. Four fields in cardDeck.js. All 29 non-Yamas cards regenerated using Yamas as voice template: titles 3-6 words invitational, paragraphs 44-56 words with "notice" language, backOpenings 32-45 words teacher voice. Yamas content locked as approved. Applied to both Meditations.jsx and PracticeCardModal.jsx.
