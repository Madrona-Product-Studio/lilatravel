...
export default function SubLabel({ children, warm = false }) {
  const color = warm ? G.goldenAmber : G.oceanTeal;
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 10, margin: '40px 0 12px' }}>
      <span style={{ width: 24, height: 1.5, background: color, display: 'block', flexShrink: 0 }} />
