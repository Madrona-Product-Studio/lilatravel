...
function Balance({ size = 22, color = 'white' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden>
      <circle cx="5" cy="12" r="6.5" stroke={color} strokeWidth="1.25" />
      <circle cx="19" cy="12" r="6.5" stroke={color} strokeWidth="1.25" />
    </svg>
  );
}
...
function Ground({ size = 22, color = 'white' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M12 21 L1 5 L23 5 Z" stroke={color} strokeWidth="1.25" strokeLinejoin="round" fill="none" />
    </svg>
  );
}
...
function Rest({ size = 22, color = 'white' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M18 2 A13 13 0 1 0 18 22 A9 9 0 1 1 18 2 Z" stroke={color} strokeWidth="1.25" fill="none" />
    </svg>
  );
}
