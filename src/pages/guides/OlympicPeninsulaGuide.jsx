        ...
        <div style={{ maxWidth: 920, margin: "0 auto", padding: isMobile ? "0 0 0 16px" : "0 40px", display: "flex", alignItems: "center" }}>
          <div style={{ flex: 1, minWidth: 0, position: "relative" }}>
            ...
            {GUIDE_SECTIONS.map((section) => { const isActive = activeId === section.id; return (
              <button key={section.id} ref={isActive ? activeItemRef : null} onClick={() => handleClick(section.id)} className="guide-nav-scroll" style={{ padding: isMobile ? "0 16px" : "0 16px", height: isMobile ? 42 : 44, background: "none", border: "none", borderBottom: `2px solid ${isActive ? C.skyBlue : "transparent"}`, cursor: "pointer", fontFamily: "'Quicksand', sans-serif", fontSize: isMobile ? 10.5 : 11, fontWeight: isActive ? 700 : 600, letterSpacing: isMobile ? "0.13em" : "0.14em", textTransform: "uppercase", color: isActive ? C.skyBlue : "#7A857E", whiteSpace: "nowrap", flexShrink: 0, transition: "color 0.25s ease, border-color 0.25s ease", position: "relative" }}
