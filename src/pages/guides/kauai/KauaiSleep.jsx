...
export default function KauaiSleep() {
  ...
  return (
    <>
      <Helmet>
        <title>Where to Stay Guide | Kauai | Lila</title>
        <meta name="description" content="Full accommodations across Poipu, Hanalei, Princeville, Kapaa & Lihue." />
      </Helmet>
      <SubGuideLayout
        title="Where to Stay Guide"
        descriptor="Full accommodations across Poipu, Hanalei, Princeville, Kapaa & Lihue."
