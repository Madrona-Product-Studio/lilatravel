// ═══════════════════════════════════════════════════════════════════════════════
// PAGE: KAUAI GUIDE (coming soon placeholder)
// ═══════════════════════════════════════════════════════════════════════════════
//
  ...
  return (
    <>
      ...
      <section style={{
        ...
        background: `url(${P.kauai}) center/cover no-repeat`,
      }}>
        <div style={{
          ...
          <div style={{ maxWidth: 920, margin: "0 auto", width: "100%" }}>
            <FadeIn from="bottom" delay={0.1}>
              ...
              <p style={{
                ...
                Emerald spires meet turquoise sea. Pure aloha — the kind you feel in your bones.
              </p>
            </FadeIn>
          </div>
        </div>
        ...
        <FadeIn>
          <div style={{ maxWidth: 520, margin: "0 auto" }}>
            ...
            <p style={{
              ...
              We're hiking the Nā Pali Coast, watching whales breach off the north shore, and finding the hidden beaches that don't make the guidebooks. Check back soon — or start planning now.
            </p>
            <Link to="/plan" style={{
