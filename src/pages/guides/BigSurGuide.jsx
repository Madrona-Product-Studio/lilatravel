// ═══════════════════════════════════════════════════════════════════════════════
// PAGE: BIG SUR GUIDE (coming soon placeholder)
// ═══════════════════════════════════════════════════════════════════════════════
//
  ...
  return (
    <>
      ...
      <section style={{
        ...
        background: `url(${P.bigSur}) center/cover no-repeat`,
      }}>
        <div style={{
          ...
          <div style={{ maxWidth: 920, margin: "0 auto", width: "100%" }}>
            <FadeIn from="bottom" delay={0.1}>
              ...
              <p style={{
                ...
                Where the mountains meet the sea and the road bends into wonder.
              </p>
            </FadeIn>
          </div>
        </div>
        ...
        <FadeIn>
          <div style={{ maxWidth: 520, margin: "0 auto" }}>
            <span style={{
              ...
              color: C.seaGlass, display: "block", marginBottom: 16,
            }}>Coming Soon</span>
            <h2 style={{
              fontFamily: "'Cormorant Garamond', serif",
            ...
            <p style={{
              ...
              We're scouting trails, tasting menus, and timing the light along the coast. Check back soon — or start planning now and we'll match you with what we know.
            </p>
            <Link to="/plan" style={{
