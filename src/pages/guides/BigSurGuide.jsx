...
function TimingAlertCapture() {
  ...
  return (
    <FadeIn>
      <div style={{ padding: "28px 24px", background: `${C.seaGlass}08`, border: `1px solid ${C.seaGlass}30`, textAlign: "center", margin: "8px 0" }}>
        {submitted ? (
          <>
            <div style={{ fontFamily: "'Quicksand', sans-serif", fontSize: 12, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: C.seaGlass, marginBottom: 8 }}>You're on the list</div>
          ...
          <>
            ...
            <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(18px, 2.5vw, 22px)", fontWeight: 400, color: C.darkInk, marginBottom: 6 }}>{"Get Big Sur timing alerts"}</div>
            <p style={{ fontFamily: "'Quicksand', sans-serif", fontSize: 14, fontWeight: 400, color: "#4A5650", lineHeight: 1.6, maxWidth: 420, margin: "0 auto 20px" }}>{"We track whale migration, wildflower bloom, and fog patterns — and let you know when it's time to go."}</p>
            <div style={{ display: "flex", gap: 8, maxWidth: 380, margin: "0 auto", flexWrap: "wrap", justifyContent: "center" }}>
              ...
              <button onClick={() => { if (email) setSubmitted(true); }} style={{ padding: "10px 20px", background: C.seaGlass, border: "none", color: "#fff", fontFamily: "'Quicksand', sans-serif", fontSize: 12, fontWeight: 700, letterSpacing: "0.16em", textTransform: "uppercase", cursor: "pointer", transition: "opacity 0.2s", whiteSpace: "nowrap" }}
...
export default function BigSurGuide() {
  ...
  return (
    <>
      ...
      <section id="light-sky" style={{ padding: isMobile ? "52px 20px" : "64px 52px", background: C.darkInk }}>
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          <FadeIn>
