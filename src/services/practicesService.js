...
export const ENTRIES = [
  ...
  // Bhakti Yoga (Narada Bhakti Sutras)
  {
    ...
    quote: { text: 'Bhakti is of the nature of supreme love for God. It is, in its own nature, the fruit of its own attainment.', source: 'Narada Bhakti Sutras 2–3' },
  ...
  },
  {
    ...
    quote: { text: 'The sage who has drunk of the nectar of love loses all outward distinctions and becomes intoxicated with bliss.', source: 'Narada Bhakti Sutras 6 (adapted)' },
  ...
  },
  {
    ...
    quote: { text: 'Singing His glory, listening to it, remembering Him — this is the highest worship.', source: 'Bhagavata Purana 7.5.23 (adapted)' },
