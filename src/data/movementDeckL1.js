        ...
        cards: [
          {
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'Lie on your back or sit tall. Place one hand on your chest, one on your belly. Breathe in through the nose — the belly hand should rise first, the chest hand barely at all. Exhale slowly through the nose or mouth. Let the belly fall. Five breaths like this to start.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'The diaphragm is the primary breathing muscle and a key spinal stabilizer. When it works properly, it creates internal pressure that supports the lower back before every movement. Chest breathing bypasses this system, keeps the body in a mild stress state, and over time contributes to back pain and tension. Relearning this breath is foundational to everything else.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Any time you feel tight, stressed, or scattered before starting movement.', scenarios: [] } },
            ],
          },
          {
            id: 'box-breathing',
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'Inhale for 4 counts. Hold for 4 counts. Exhale for 4 counts. Hold for 4 counts. Repeat 4–6 cycles. Start with a count that feels comfortable — 3 or 4 — and lengthen over time. Keep the breath smooth, not forced.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Slow, structured breathing activates the parasympathetic nervous system — the rest-and-digest response. Regular practice lowers resting heart rate, reduces anxiety, and improves focus. The technique is used by military and emergency personnel before high-stakes situations precisely because it works quickly and requires nothing but breath.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Before meditation, before a challenging pose sequence, or any time the mind won\'t settle.', scenarios: [] } },
            ],
          },
          {
            id: 'ujjayi',
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'Breathe in through the nose. As you exhale, gently constrict the back of the throat — as if fogging a mirror, but with the mouth closed. You\'ll hear a soft, ocean-like sound. Apply this to both the inhale and exhale. The sound should be audible to you but not to someone nearby.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Ujjayi links breath to movement and creates internal heat. The sound acts as a continuous feedback signal — if it stops or becomes forced, something in the body or mind has tensed up. It also slightly increases resistance in the airway, which may strengthen the breathing muscles over time, and creates a meditative focus point throughout practice.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Any flowing practice where you want breath and movement to stay connected.', scenarios: [] } },
            ],
          },
          {
            id: 'cat-cow',
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'Begin on hands and knees, wrists under shoulders, knees under hips. Inhale: let the belly drop, tailbone lifts, chest opens — this is Cow. Exhale: press the floor away, round the spine toward the ceiling, tuck the tailbone — this is Cat. Move slowly. Spend time noticing which segments of the spine move freely and which resist.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Moving between full spinal flexion and full extension with the breath trains the coordination between the diaphragm and the pelvic floor. It reveals where the spine is stiff and where it overcompensates. Done slowly and attentively, it is one of the most effective tools for restoring spinal mobility and reducing morning stiffness.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'First thing in the morning, or whenever the spine feels compressed and stiff.', scenarios: [] } },
            ],
          },
          {
            id: 'tadasana',
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'Stand with feet hip-width apart. Root through all four corners of both feet. Stack ankles, knees, hips, shoulders. Let arms hang naturally. Lengthen through the crown of the head. Hold for 5–10 breaths, noticing where your weight falls and where your body wants to compensate.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Tadasana trains the postural muscles along the entire spine and teaches the nervous system what neutral alignment feels like. Most people have never stood in true neutral — they lean, compress, or hold in ways they can\'t feel anymore. Regular practice of this pose recalibrates how you stand, walk, and load your body in everything you do.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Resetting after long periods of sitting or driving before a hike or activity.', scenarios: [] } },
            ],
          },
        ],
      },
      {
        ...
        cards: [
          ...
          },
          {
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'From hands and knees, tuck the toes and lift the hips toward the ceiling. Press the floor away with straight arms. Pedal the feet a few times to warm the calves, then press both heels toward the floor. Release the neck — head between the arms. Hold 5–10 breaths.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Downward dog stretches the calves, hamstrings, and back while strengthening the shoulders, arms, and core simultaneously. The ankle bend required reveals calf and Achilles tightness immediately. As the body warms up, the chest moves toward the thighs and the spine lengthens — it becomes more open each time you return to it during practice.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Between standing poses to reset, or as a morning wake-up when the whole body feels stiff.', scenarios: [] } },
            ],
          },
          {
            id: 'plank',
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'From hands and knees, step feet back until the body forms a straight line from head to heel. Hands under shoulders, fingers spread. Press the floor away — don\'t let the chest sink toward it. Draw the lower belly gently in. Keep the head in line with the spine. Hold 5–10 breaths or build up gradually.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Plank strengthens the entire front of the body — shoulders, chest, core, and hip flexors — in one integrated position. More importantly, it trains the body to hold its structure under load, which directly transfers to every standing and balancing pose. The most common error is letting the hips sag or rise — both indicate the core isn\'t engaging.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Building the baseline strength needed before arm balances, or any time you want a full-body wake-up.', scenarios: [] } },
            ],
          },
          {
            id: 'upward-dog',
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'From prone, place hands under shoulders. Press the floor away and lift the chest, keeping the tops of the feet pressing down. Straighten the arms fully, lifting the thighs off the floor. Roll the shoulders back and down. Lift the gaze slightly — don\'t crane the neck back sharply. Hold 3–5 breaths.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Upward dog reverses the forward-collapsed posture most people carry through the day. It opens the chest and the front of the hips while strengthening the muscles along the spine. The key distinction from Cobra is the lifted thighs — this keeps the pose active and prevents compression in the lower back.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Counteracting hours of sitting or forward-leaning posture.', scenarios: [] } },
            ],
          },
          {
            id: 'chair',
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'Stand with feet hip-width or together. Inhale, then as you exhale bend the knees and sit back as if lowering onto a chair. Keep the chest lifted — resist the urge to fold forward. Arms reach overhead or forward. Weight stays in the heels. Hold 5–8 breaths.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Chair pose strengthens the quads, glutes, and lower back simultaneously while demanding that the spine stay long under load. It builds the leg strength that protects the knees on descents and the lower back during lifting. The challenge is maintaining an upright torso as the legs fatigue — this is where the real work happens.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Building leg and lower back endurance before a day of hiking, especially if descents are planned.', scenarios: [] } },
            ],
          },
        ],
      },
        ...
        cards: [
          {
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'Step one foot back 3–4 feet. Front knee bends to 90° over the ankle. Back foot turns out 45°. Square the hips toward the front. Raise arms overhead. Hold 5–8 breaths, then switch sides.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Warrior I stretches the hip flexors of the back leg — the deep muscles that shorten with prolonged sitting — while strengthening the quad and glute of the front leg. Squaring the hips requires real effort, which is where the deepest stretch lives. It also builds single-leg stability essential for uneven terrain.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Tight hips and lower back after long days sitting, driving, or in a saddle.', scenarios: [] } },
            ],
          },
          {
            id: 'warrior-ii',
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'Step one foot back 3–4 feet. Front foot points forward, back foot turns 90°. Bend the front knee to 90° — directly over the ankle. Extend arms to shoulder height, parallel to the floor. Face the side. Gaze over the front hand. Hold 5–10 breaths, then switch.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Warrior II strengthens the outer hip and thigh of the front leg while building endurance in the shoulders and upper back. It works in the side-to-side plane — a direction that gets far less attention than forward and back movement in most training. The common error is the front knee drifting inward, which reveals that the outer hip needs more attention.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Building the hip stability needed for traversing uneven or sloped terrain.', scenarios: [] } },
            ],
          },
          {
            id: 'deep-squat',
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'Stand feet slightly wider than hip-width, toes turned out 30–45°. Lower into a deep squat toward the floor. Press elbows into inner knees to open the hips. If the heels rise, place a folded blanket beneath them. Hold 5–10 breaths.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Limited ankle mobility is one of the most overlooked contributors to knee pain, back pain, and poor squat mechanics. When the ankles can\'t bend fully, everything above them compensates — heels rise, knees collapse inward, lower back rounds. Regular practice of this pose gradually restores that ankle range, and when it does, every squat, step, and landing tends to improve with it.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Any time the ankles feel tight, or as preparation before activities involving repeated step-downs or descents.', scenarios: [] } },
            ],
          },
          {
          ...
          },
          {
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'From downward dog, bring the right knee toward the right wrist. Lower the shin toward diagonal. Lower the back knee to the mat, extending the back leg straight behind. Square the hips down. Inhale to lengthen, then exhale and fold forward over the front shin. Hold 5–10 breaths, then switch sides.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'The hip rotators — deep muscles beneath the glutes — are among the most commonly tight in people who sit, run, or cycle. When they\'re restricted, the lower back and knee compensate. Pigeon prep is a long, sustained stretch directly into this group. The release, over repeated practice, reduces load on both the knee and the spine.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Hip tightness after running, cycling, or long days in the car. One of the most effective recovery poses available.', scenarios: [] } },
            ],
          },
        ],
      },
        ...
        cards: [
          {
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'Stand with feet 3–4 feet apart. Right foot forward, left foot turned 90°. Extend arms to a T. Inhale to lengthen. Exhale and hinge sideways over the right leg, reaching the right hand toward the shin, ankle, or a block. Left arm reaches to the ceiling. Keep both sides of the waist long. Hold 5–8 breaths, then switch.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Triangle pose lengthens the entire side of the body — from the outer ankle up through the hip, waist, and ribs — while strengthening the outer hip of the standing leg. Most movement happens forward and back; the side-to-side plane is underworked and often surprisingly tight. The key is keeping the chest open toward the ceiling rather than rotating toward the floor.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Side-body tightness, or after activities that compress one side more than the other.', scenarios: [] } },
            ],
          },
          {
            id: 'tree',
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'Stand on one foot. Bring the other foot to the inner calf or inner thigh — not the knee. Press the foot and inner leg into each other equally. Bring hands to heart or raise them overhead. Fix your gaze on a still point. Hold 5–10 breaths, then switch.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Single-leg balance demands full coordination between the foot, ankle, hip, and core. The wobble is information — it shows exactly where that coordination is weakest. Regular practice improves proprioception (the body\'s sense of its own position), which directly reduces ankle sprains and improves stability on uneven ground.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Improving ankle stability and body awareness before technical terrain.', scenarios: [] } },
            ],
          },
          {
            id: 'warrior-3',
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'From standing, shift weight onto one foot. Hinge forward from the hip, extending the back leg as the torso lowers toward horizontal. Arms reach forward or rest on hips. Keep both hips square to the floor. Hold 5–8 breaths, then switch. Use a wall or chair for support while building strength.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Warrior III strengthens the standing leg\'s glute and hamstring while demanding balance throughout the whole body. It trains the body to maintain alignment under real load — a direct transfer to walking, running, and climbing on uneven terrain. The most common collapse is in the hip of the lifted leg rotating open.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Building the single-leg strength and balance needed for trail running, scrambling, or any uneven surface.', scenarios: [] } },
            ],
          },
          {
            id: 'half-moon',
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'From Triangle pose, bend the front knee and bring the front hand to the floor or a block about a foot forward. Shift weight onto the front foot and lift the back leg to hip height. Stack the hips and open the chest toward the ceiling. Extend the top arm upward. Hold 5–8 breaths, then switch.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Half Moon combines the lateral stretch of Triangle with the single-leg demand of balance poses, making it one of the more complete standing poses in the sequence. It builds outer hip strength, opens the chest and inner groins, and trains the coordination needed to feel stable in an unstable position.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'After the body is well warmed up and the hips have been opened — this pose earns its depth from what came before.', scenarios: [] } },
            ],
          },
          {
            id: 'dancer',
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'Stand on one foot. Bend the other knee and reach back to hold the inner ankle or foot. Press the foot into the hand as you hinge forward slightly, lifting the back leg and extending the free arm forward. Keep the standing hip stable. Hold 5–8 breaths, then switch.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Dancer\'s pose opens the hip flexors and chest of the lifted side while demanding full-body balance. The press of the foot into the hand is what creates the arc — passive holding doesn\'t open the pose. It builds the shoulder and hip mobility that longer, more demanding backbends eventually require.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'When the hips and chest are already well warmed and open — this is near the end of a sequence for good reason.', scenarios: [] } },
            ],
          },
        ],
      },
        ...
        cards: [
          {
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'Sit with knees bent, feet flat. Lean back slightly and balance on the sit bones. Lift the feet, shins parallel to the floor. Extend arms forward. Keep the spine long — if it rounds, keep the knees bent. Hold 3–5 breaths, rest, and repeat.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Boat pose builds hip flexor strength and challenges core stability while the spine stays long and neutral. The hip flexors are doing the heavy lifting — the core works to keep the spine from collapsing under that load. The temptation is to round the back to reach the full pose — but a shorter, flatter version with a long spine is more effective than the full shape with a rounded back. The wobble and the effort to stay upright is exactly the point.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Building the core endurance that protects the lower back on long days of carrying weight.', scenarios: [] } },
            ],
          },
          {
            id: 'bridge-pose',
          ...
          },
          {
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'Sit with legs extended, feet flexed. Inhale to lengthen the spine upward. Exhale and hinge forward from the hips, reaching for the shins, ankles, or feet. Keep the spine as long as possible — a flat back reaching forward is more effective than a rounded back reaching for the toes. Hold 8–10 breaths.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Paschimottanasana stretches the entire posterior chain — calves, hamstrings, glutes, and spinal extensors — in one sustained hold. The seated position removes balance from the equation, allowing the body to focus entirely on releasing. The forward fold also calms the nervous system, making it both a stretch and a transition toward rest.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Hamstring and lower back tightness, or as a transitional pose between active and restorative sections of practice.', scenarios: [] } },
            ],
          },
          {
            id: 'fish',
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'Lie on your back, legs extended. Place hands under the hips, palms down. Press the forearms and elbows into the floor and lift the chest, arching the upper back. Allow the top of the head to gently rest on the floor or hover. Hold 5–8 breaths. To come out, press the forearms down and lift the head before lowering the back.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Fish pose is a supported backbend that opens the chest and the front of the throat — areas that close off with forward head posture and rounded shoulders. The forearms bear the weight rather than the neck, making it accessible and safe. It is often practiced as a counter-pose after forward folds or shoulder stands.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Chest and throat tightness, or as a counter-pose after extended forward-folding sequences.', scenarios: [] } },
            ],
          },
          {
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'Lie on your back. Bring the soles of the feet together and let the knees fall open toward the floor. Place hands on the belly or extend arms to the sides. Close the eyes. Let gravity do the work — don\'t press the knees down. Hold 5–10 minutes if possible.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'The inner groins and hip rotators release passively with gravity over time in this pose. Unlike active stretching, the long hold allows the nervous system to register safety in the open position and gradually permit more range. This is one of the best poses for hip tightness because it works through time and weight rather than effort.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Hip tightness that doesn\'t respond to active stretching, or as a transitional pose before savasana.', scenarios: [] } },
            ],
          },
        ],
      },
        ...
        cards: [
          {
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'From hands and knees, bring big toes together and widen the knees to the edges of the mat. Lower the hips toward the heels. Walk the hands forward and rest the forehead on the mat or a block. Breathe into the back of the ribcage. Hold as long as needed — this pose has no minimum or maximum.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Child\'s pose decompresses the posterior elements of the lumbar spine, opens the upper back through the extended arms, and supports the body\'s shift into rest through a combination of the curled posture, supported position, and gentle inward withdrawal. It is both a physical release and a neurological reset — the dual benefit that makes it the most reached-for resting pose in practice.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Any time during practice when the body or breath needs to settle. There is no wrong time for child\'s pose.', scenarios: [] } },
            ],
          },
          {
            id: 'supine-twist',
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'Lie on your back. Draw the right knee to the chest, then guide it across the body to the left while extending the right arm to the right. Look right if comfortable. Let the twist be passive — no forcing. Hold 5–10 breaths, then switch sides.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'The supine twist releases tension in the muscles surrounding the lumbar spine and opens the thoracic back with full support from the floor. Unlike seated twists, nothing has to work to maintain position — the body can fully release. It also gently stretches the outer hip of the crossed leg, making it a two-for-one at the end of practice.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'Lower back tension after any activity, or as the final active pose before savasana.', scenarios: [] } },
            ],
          },
          {
            id: 'happy-baby',
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'Lie on your back. Draw both knees toward the chest, then open them wide. Reach for the outer edges of the feet or the backs of the thighs. Flex the feet toward the ceiling. Gently use the arms to draw the knees toward the floor beside the ribs. Rock side to side slowly if it feels good. Hold 5–10 breaths.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Happy baby stretches the inner groins and hip rotators while releasing tension across the lower back. The side-to-side rock provides a mild massage along the spine. It is one of the most effective and accessible hip openers precisely because everything is supported by the floor and nothing has to be held or stabilized.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'End of any practice, or when the lower back and hips need gentle release without any effort.', scenarios: [] } },
            ],
          },
          {
            id: 'legs-up-the-wall',
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'Sit sideways next to a wall. Lie down and swing the legs up the wall, scooting the sit bones close. Arms rest by the sides or on the belly. Close the eyes. Stay 5–15 minutes. To come out, bend the knees, push away from the wall, and roll to one side.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'With the legs elevated, the lower back releases, the hip flexors let go passively, and gravity assists venous return — the blood that pools in the lower legs flows back toward the heart more easily. The parasympathetic nervous system activation — the body shifting into rest mode — makes this one of the most effective recovery tools available. It costs nothing and can be done anywhere there\'s a wall.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'After any long day of physical activity, travel, or sustained standing. Also excellent for swollen feet and ankles.', scenarios: [] } },
            ],
          },
          {
            id: 'savasana',
            ...
            tabs: [
              { label: 'How to Enter', shape: 'steps', content: [{ text: 'Lie flat on your back. Let the feet fall open naturally. Arms slightly away from the body, palms up. Close the eyes. Release all effort — including the effort to relax. Stay a minimum of 5 minutes. Longer is better.' }] },
              { label: 'Activates', shape: 'activates', content: [{ pattern: '', description: 'Savasana shifts the nervous system from the active, effortful state of practice into parasympathetic recovery — the state where adaptation begins. Neuroscience research on rest and motor consolidation suggests the brain replays and consolidates movement patterns during quiet rest after practice. Skipping it cuts that process short. It is not optional. It is where the work lands.' }] },
              { label: 'Good For', shape: 'good-for', content: { summary: 'The end of every practice, without exception.', scenarios: [] } },
            ],
          },
        ],
      },
