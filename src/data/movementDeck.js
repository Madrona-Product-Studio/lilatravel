/**
 * movementDeck.js — Lila Movements Card Deck Data
 * ═════════════════════════════════════════════════
 *
 * Full content ported from Kaya repository.
 *
 * Structure: MOVEMENT_CHAPTERS[] → each chapter has groups[] → each group has cards[].
 */

export const MOVEMENT_CHAPTERS = [
  {
  ...
  },
  {
    ...
    desc: 'Where understanding meets the body. Poses anchored to the anatomy and concepts you\'ve learned — not just shapes, but reasons.',
    accent: '#4A7A5A',
    groups: [
      {
        ...
        cards: [
          {
            ...
            tabs: [
              ...
              {
                label: 'Why It Matters',
                content: 'Backbends practiced with thoracic awareness — even small ones like sphinx or cobra — are profoundly therapeutic. They directly counteract the chronic flexion posture of sitting and screens. They open the anterior chest, stretch the hip flexors, strengthen the posterior chain, and restore spinal extension capacity that most people are gradually losing. The goal of a backbend is not to look impressive — it is to restore what modern life has taken away.',
              },
              {
                label: 'What To Do',
                content: [
...
export function getAllGroups() {
  return MOVEMENT_CHAPTERS.flatMap(ch => ch.groups);
}

export function getTotalCards() {
  return MOVEMENT_CHAPTERS.reduce(
